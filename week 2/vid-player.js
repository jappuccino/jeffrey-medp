...
.controls button[data-state="pause.jpg"] {
	background-image: url('buttons-04.png');
}
.controls button[data-state="stop"] {
	background-image: url('buttons-05.png');
}
.controls button[data-state="mute"] {
	background-image: url('mute.jpg');
}
.controls button[data-state="unmute"] {
	background-image: url('buttons-08.png');
}
.controls button[data-state="volup"] {
	background-image: url('volup.jpg');
}
.controls button[data-state="voldown"] {
	background-image: url('voldown.jpg');
}
